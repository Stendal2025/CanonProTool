...
<a id="gps-link" target="_top" style="display:inline-block;padding:12px;background:#238636;color:white;text-decoration:none;border-radius:6px;font-weight:bold;font-size:15px;">✅ Koordinaten übernehmen</a>
</div></div>
<script>
...
fetch('https://nominatim.openstreetmap.org/reverse?format=json&lat='+lat+'&lon='+lon+'&zoom=10&addressdetails=1',{headers:{'Accept-Language':'de','User-Agent':'CanonProTool/1.0'}})
